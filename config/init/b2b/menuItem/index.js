module.exports.init = async () => {
  try {
    ...
    let newMenuItems = [
      ...
      { href: '/admin/productimage', title: '產品圖片', sequence: 60, ParentMenuItemId: 3},
      ...
      { href: '/admin/orderhistory', title: '訂單歷程', sequence: 40, ParentMenuItemId: 4},
      ...
      { href: '/admin/imagelist?imageList', title: '更換前台背景圖片', sequence: 30, ParentMenuItemId: 6  },

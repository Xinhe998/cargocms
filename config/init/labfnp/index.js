...
module.exports.init = async () => {
  try {
    ...
    let newMenuItems = [
      ...
      { href: '/admin/user', title: '會員資料', sequence: 20, ParentMenuItemId: 2, model: 'user'},
      { href: '/admin/post', title: '內容資料', sequence: 30, ParentMenuItemId: 2, model: 'post'},
      { href: '/admin/event', title: '活動票券', sequence: 40, ParentMenuItemId: 2, model: 'event'},
      { href: '/admin/labfnp/recipe', title: '配方資料', sequence: 50, ParentMenuItemId: 2, model: 'recipe'},
      { href: '/admin/labfnp/scent', title: '香味分子', sequence: 60, ParentMenuItemId: 2, model: 'scent'},
      { href: '/admin/labfnp/scentnote', title: '香調', sequence: 70, ParentMenuItemId: 2, model: 'scentnote'},
      // { href: '/admin/labfnp/scentfeedback', title: '香調回饋', sequence: 80, ParentMenuItemId: 2},
      { href: '/admin/labfnp/feeling', title: '感覺', sequence: 90, ParentMenuItemId: 2, model: 'feeling'},
      { href: '/admin/quote', title: '箴言', sequence: 100, ParentMenuItemId: 2, model: 'quote'},
      { href: '/admin/allpay', title: '訂單', sequence: 110, ParentMenuItemId: 2, model: 'allpay'},
      { href: '/admin/eventallpay', title: '票券訂單', sequence: 120, ParentMenuItemId: 2, model: 'eventallpay'},
      { href: '/admin/facebook/feed', title: '動態', sequence: 130, ParentMenuItemId: 2, model: 'feed'},
      { href: '/admin/message', title: '訊息', sequence: 140, ParentMenuItemId: 2, model: 'message'},
      { href: '/admin/contact', title: '聯繫訊息', sequence: 150, ParentMenuItemId: 2, model: 'contact'},
      { href: '/admin/role', title: '權限', sequence: 160, ParentMenuItemId: 2, model: 'role'},
      { href: '/admin/roledetail', title: '詳細權限', sequence: 170, ParentMenuItemId: 2, model: 'roledetail'},
      { href: '/admin/mock', title: '隨機資料表', sequence: 20, ParentMenuItemId: 3, model: 'mock'},

      { href: '/admin/product', title: '產品', sequence: 20, ParentMenuItemId: 4, model: 'product'},
      { href: '/admin/productdescription', title: '產品描述', sequence: 30, ParentMenuItemId: 4, model: 'productdescription'},

      { href: '/admin/order', title: '訂單', sequence: 20, ParentMenuItemId: 5, model: 'order'},
      { href: '/admin/orderproduct', title: '產品訂單', sequence: 30, ParentMenuItemId: 5, model: 'orderproduct'},

      { href: '/admin/supplier', title: '供應商清單', sequence: 20, ParentMenuItemId: 6, model: 'supplier'},
      { href: '/admin/suppliershiporder', title: '供應商出貨訂單', sequence: 30, ParentMenuItemId: 6, model: 'suppliershiporder'},
      { href: '/admin/suppliershiporderdescription', title: '供應商詳細出貨訂單', sequence: 40, ParentMenuItemId: 6, model: 'suppliershiporderdescription'},
